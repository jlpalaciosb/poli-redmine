...
from .views import RolListJson,RolListView,RolCreateView,RolUpdateView,RolPerfilView,RolEliminarView
...
urlpatterns = [
    ...
    url(r'^(?P<rol_id>\d+)/eliminar/$', RolEliminarView.as_view(), name='eliminar'),
]