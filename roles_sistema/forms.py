...
from proyecto.models import RolAdministrativo, Proyecto, Cliente, Usuario
...
class RolSistemaForm(ModelForm):
    permissions = PermisosModelMultipleChoiceField(
        queryset=Permission.objects.filter(
            Q(content_type__app_label=Proyecto._meta.app_label,content_type__model=Proyecto._meta.model_name, codename='add_proyecto') |
            Q(content_type__app_label=Usuario._meta.app_label,content_type__model=Usuario._meta.model_name) |
