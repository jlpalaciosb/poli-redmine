...
from proyecto.forms import USForm, EditarMiembroForm
...
class USCreateView(SuccessMessageMixin, PermisosPorProyectoMixin, LoginRequiredMixin, CreateView):
    ...
    def get_form_kwargs(self):
        ...
        kwargs.update({
            'success_url': reverse('perfil_proyecto', kwargs=self.kwargs),
...
class MiembroProyectoListJsonView(PermisosEsMiembroMixin, LoginRequiredMixin, BaseDatatableView):
    ...
    def filter_queryset(self, qs):
        ...
        qs_params = Q(user__username__icontains=search) | Q(user__first_name__icontains=search) | Q(
